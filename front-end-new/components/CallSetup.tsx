...
export default function CallSetup({ onJoin }: CallSetupProps) {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg p-8 max-w-md w-full mx-4 shadow-xl">
        <div className="text-center">
          <h2 className="text-2xl font-bold text-gray-900 mb-2">Join Call Room</h2>
          <p className="text-gray-600 mb-6">Enter your username to start making calls</p>
